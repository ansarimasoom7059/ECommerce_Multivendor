...
import com.ansari.repository.VerificationCodeRepository;
import com.ansari.response.ApiResponse;
import com.ansari.response.AuthResponse;
import com.ansari.service.*;
import com.ansari.service.impl.CustomeUserServiceImplementation;
import com.ansari.utils.OtpUtils;
...
public class SellerController {
    ...
    public ResponseEntity<ApiResponse> sentLoginOtp(@RequestBody VerificationCode req) throws MessagingException, SellerException {
        ...
        String subject = "Mn Bazaar Login Otp";
...
//        Seller savedSeller = sellerService.createSeller(seller);
    ...
    public ResponseEntity<Seller> createSeller(@RequestBody Seller seller) throws SellerException, MessagingException {
        ...
        String subject = "Mn Bazaar Email Verification Code";
        String text = "Welcome to Mn Bazaar, verify your account using this link ";
